<script>
	...
	const psalm63 = getPsalmMeta(63);
</script>

<ShowPsalm ps={62} from={9} />

<PsalmNumber n={psalm63.number} />
<SectionTitle fancy text={psalm63.name} latin_size />
<ShowPsalm ps={63} to={9} />

<PageNumber page={346} text="the psalter" />
