...
<TextBlock
	text="Therefore, O Lord and heavenly Father, according to the
...
<TextBlock
	optional
	text="And we earnestly desire your fatherly goodness mercifully to
...
/>
<TextBlock
	text="And here we offer and present to you, O Lord, ourselves, our
souls and bodies, to be a reasonable, holy, and living sacrifice. We
...
<TextBlock
	optional
	text="And although we are unworthy, because of our many sins, to
offer you any sacrifice, yet we ask you to accept this duty and
service we owe, not weighing our merits, but pardoning our
offenses, through Jesus Christ our Lord."
/>
<TextBlock
	text="By him, and with him, and in him, in the unity of the Holy
Spirit, all honor and glory is yours, Almighty Father, now and
for ever. **Amen.**"
/>

<PageNumber page={117} text="holy eucharist | anglican standard text" />
