...
<SectionTitle text="prayer for mission" />
<TextBlock
	text="O God and Father of all, whom the whole heavens adore:
...
<OrThis />
<TextBlock
	text="O God, you manifest in your servants the signs of your
