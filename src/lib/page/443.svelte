<script>
	...
	const psalm125 = getPsalmMeta(125);
</script>

<ShowPsalm ps={124} from={2} />

<PsalmNumber n={psalm125.number} />
<SectionTitle fancy text={psalm125.name} latin_size />
<ShowPsalm ps={125} />

<PageNumber page={443} text="Day 27: Morning Prayer | Psalm 125 |" />
