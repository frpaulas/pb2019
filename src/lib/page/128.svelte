...
<SectionTitle text="the prayers of the people" />
<Rubric
...
<TextBlock
	text="For the peace of the whole world, and for the well-being and
    unity of the people of God."
/>
<PopResponse />
<TextBlock
	text="For N., our Archbishop, and N., our Bishop, and for all the
    clergy and people of our Diocese and Congregation."
/>"
<PopResponse />
<TextBlock
	text="For all those who proclaim the Gospel at home and abroad; and
    for all who teach and disciple others."
/>
<PopResponse />
<TextBlock
	text="For our brothers and sisters in Christ who are persecuted for
    their faith."
/>"
<PopResponse />
<TextBlock
	text="For our nation, for those in authority, and for all in public
