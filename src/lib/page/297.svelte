<script>
	...
	const psalm25 = getPsalmMeta(25);
</script>

<PsalmNumber n={psalm25.number} />
<SectionTitle fancy text={psalm25.name} latin_size />
<ShowPsalm ps={25} to={13} />

<PageNumber page={297} text="Day 5: Morning Prayer | Psalm 25 |" />
