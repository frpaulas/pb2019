<script>
	...
	const psalm64 = getPsalmMeta(64);
</script>

<ShowPsalm ps={63} from={10} />

<PsalmNumber n={psalm64.number} />
<SectionTitle fancy latin_size>{psalm64.name}</SectionTitle>
<ShowPsalm ps={64} />

<PageNumber page={347} text="Day 12: Morning Prayer | Psalm 64 |" />
