<script>
	...
	const psalm74 = getPsalmMeta(74);
</script>

<PsalmNumber n={psalm74.number} />
<SectionTitle fancy latin_size>{psalm74.name}</SectionTitle>
<ShowPsalm ps={74} to={12} />

<PageNumber page={363} text="Day 14: Evening Prayer | Psalm 74 |" />
